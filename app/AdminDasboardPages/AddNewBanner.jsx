            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    >
                      <div className="flex items-center space-x-2 text-gray-500">
                        <Upload size={20} />
                        <span>
                          {bannerData.mainImage ? bannerData.mainImage.name : "Choose File"}
                        </span>
                      </div>
                    </label>
                  </div>
                  {!bannerData.mainImage && (
                    <p className="text-sm text-red-500 mt-1">Please select an image file</p>
                  )}
                </div>
                ...
                <button
                  ...
                  disabled={!bannerData.title || !bannerData.priority || !bannerData.mainImage}
                ...
                {(!bannerData.title || !bannerData.priority || !bannerData.mainImage) && (
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                {bannerData.imagePreview && (
                  <div className="mt-4 p-3 bg-white rounded-lg border">
                    ...
                    <p className="text-xs text-gray-600">Title: {bannerData.title || "Untitled"}</p>
                    <p className="text-xs text-gray-600">Priority: {bannerData.priority || "Not set"}</p>
                    <p className="text-xs text-gray-600">For: {bannerData.for}</p>
                  </div>
                )}
              </div>
            </div>
