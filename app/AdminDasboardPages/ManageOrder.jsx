        ...
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="px-8 py-6 border-b border-gray-200/60 bg-gradient-to-r from-slate-50 to-gray-50">
              <div className="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex space-x-3">
                  <button 
                    onClick={() => handleButtonClick("back-edit", () => setEditingOrder(null))}
                    className={`px-6 py-3 bg-slate-500 text-white rounded-2xl font-semibold transition-all duration-300 flex items-center space-x-2 transform ${
                      clickedButton === "back-edit" ? "scale-95 bg-slate-600 shadow-lg" : "hover:bg-slate-600 hover:shadow-lg hover:scale-105"
                    }`}>
                    <ArrowLeft size={18} />
                  ...
                  <button 
                    ...
                    className={`px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-2xl font-semibold transition-all duration-300 flex items-center space-x-2 transform ${
                      clickedButton === "save-edit" ? "scale-95 from-emerald-600 to-teal-700 shadow-lg" : "hover:from-emerald-600 hover:to-teal-700 hover:shadow-xl hover:shadow-emerald-500/25 hover:scale-105"
                    }`}>
                    <Save size={18} />
              ...
              <div className="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between">
                ...
                <button 
                  ...
                  className={`px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-2xl font-semibold transition-all duration-300 flex items-center space-x-2 transform ${
                    clickedButton === "add-item" ? "scale-95 from-blue-600 to-indigo-700 shadow-lg" : "hover:from-blue-600 hover:to-indigo-700 hover:shadow-xl hover:scale-105"
                  }`}>
                  <Plus size={18} />
                  <span>Add Item</span>
                </button>
            ...
            <div className="p-8">
              <div className="space-y-6">
                {editingOrder.items.map((item, index) => (
                  <div key={index} className="group bg-gradient-to-r from-white to-slate-50/50 rounded-2xl border border-slate-200/60 hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
                    <div className="p-6">
                      {/* Item Header */}
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            <h4 className="font-bold text-slate-800 text-lg">Lot: SW9K000{index + 4}</h4>
                            <p className="text-sm text-slate-500">Item #{index + 1}</p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-2">
                          <button 
                            onClick={() => handleButtonClick(`edit-item-${index}`)}
                            className={`p-2 text-blue-500 hover:bg-blue-50 rounded-xl transition-all duration-300 opacity-0 group-hover:opacity-100 transform ${
                              clickedButton === `edit-item-${index}` ? "scale-90 bg-blue-100" : "hover:scale-110"
                            }`}>
                            <Edit size={16} />
                          </button>
                          <button 
                            onClick={() => handleButtonClick(`delete-item-${index}`)}
                            className={`p-2 text-red-500 hover:bg-red-50 rounded-xl transition-all duration-300 opacity-0 group-hover:opacity-100 transform ${
                              clickedButton === `delete-item-${index}` ? "scale-90 bg-red-100" : "hover:scale-110"
                            }`}>
                            <Trash2 size={16} />
                          </button>
                        </div>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                        <div className="lg:col-span-2">
                          <label className="text-sm font-semibold text-slate-700 block mb-2">Item Name</label>
                          <input 
                            type="text" 
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-6 pt-4 border-t border-slate-200/50">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-6 space-y-1 sm:space-y-0">
                          <div className="text-sm text-slate-600">
                            SKU: <span className="font-semibold text-slate-800">JWL{1000 + index}</span>
                          </div>
                          <div className="text-sm text-slate-600">
                            Category: <span className="font-semibold text-slate-800">Jewelry</span>
                          </div>
                        </div>
              ...
              <div className="mt-8 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-8 border border-emerald-200/50 shadow-lg">
                <div className="grid grid-cols-3 gap-6">
                  <div className="text-center">
                    <p className="text-sm text-slate-600 mb-2 font-medium">Total Items</p>
                    <p className="text-3xl font-bold text-slate-800">{editingOrder.items.length}</p>
                  </div>
                  <div className="text-center">
                    <p className="text-sm text-slate-600 mb-2 font-medium">Total Quantity</p>
                    <p className="text-3xl font-bold text-slate-800">
                      {editingOrder.items.reduce((sum, item) => sum + item.quantity, 0)}
                    </p>
                  </div>
                  <div className="text-center">
                    <p className="text-sm text-slate-600 mb-2 font-medium">Grand Total</p>
                    <p className="text-4xl font-bold text-emerald-600">{editingOrder.total}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/60 overflow-hidden">
            ...
            <div className="p-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div>
                    <label className="text-sm font-semibold text-slate-700 block mb-2">Member Name</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label className="text-sm font-semibold text-slate-700 block mb-2">Email Id</label>
                  ...
                  <div>
                    <label className="text-sm font-semibold text-slate-700 block mb-2">Mobile No</label>
                    <div className="relative">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="text-sm font-semibold text-slate-700 block mb-2">Country</label>
                      <input 
                        type="text" 
                        defaultValue="India"
                        className="w-full px-4 py-3 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 bg-white font-medium"
                  ...
                  <div>
                    <label className="text-sm font-semibold text-slate-700 block mb-2">Pincode</label>
                    <input 
                      type="text" 
                      defaultValue="70079"
                      className="w-full px-4 py-3 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 bg-white font-medium"
          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/60 overflow-hidden">
            ...
            <div className="p-8">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div>
                  <label className="text-sm font-semibold text-slate-700 block mb-2">Current Status</label>
                  <select 
                ...
                <div>
                  <label className="text-sm font-semibold text-slate-700 block mb-2">Order Date</label>
                  <input 
                    type="date" 
                ...
                <div>
                  <label className="text-sm font-semibold text-slate-700 block mb-2">Order Time</label>
                  <input 
                    type="time" 
                    defaultValue="05:45"
                    className="w-full px-4 py-3 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 bg-white font-medium"/>
          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/60 p-8">
            <div className="flex flex-col sm:flex-row gap-4 sm:justify-end">
              <button 
                onClick={() => handleButtonClick("cancel-edit", () => setEditingOrder(null))}
                className={`px-8 py-4 bg-slate-500 text-white rounded-2xl font-bold transition-all duration-300 flex items-center justify-center space-x-2 transform ${
                  clickedButton === "cancel-edit" ? "scale-95 bg-slate-600 shadow-lg" : "hover:bg-slate-600 hover:shadow-lg hover:scale-105"
                }`}>
                <X size={20} />
                <span>Cancel</span>
              </button>
              <button 
                ...
                className={`px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-2xl font-bold transition-all duration-300 flex items-center justify-center space-x-2 transform ${
                  clickedButton === "update-order" ? "scale-95 from-emerald-600 to-teal-700 shadow-lg" : "hover:from-emerald-600 hover:to-teal-700 hover:shadow-xl hover:shadow-emerald-500/25 hover:scale-105"
                }`}>
                <Save size={20} />
          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/60 overflow-hidden">
              ...
              <div className="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex space-x-3">
                  <button 
                    ...
                    className={`px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-2xl font-semibold transition-all duration-300 flex items-center space-x-2 transform ${
                      clickedButton === "export" ? "scale-95 from-emerald-600 to-teal-700 shadow-lg" : "hover:from-emerald-600 hover:to-teal-700 hover:shadow-xl hover:shadow-emerald-500/25 hover:scale-105"
                    }`}>
                    <Download size={18} />
                    <span>Export</span>
                  </button>
                  <button 
                    ...
                    className={`px-6 py-3 bg-white/80 text-slate-700 rounded-2xl font-semibold border border-slate-200 transition-all duration-300 flex items-center space-x-2 transform ${
                      clickedButton === "refresh" ? "scale-95 bg-slate-100 shadow-lg" : "hover:bg-white hover:shadow-lg hover:scale-105"
                    }`}>
                    <RefreshCw size={18} />
                    <span>Refresh</span>
                  </button>
            ...
            <div className="px-8 py-6 bg-gradient-to-r from-gray-50 to-slate-50 border-b border-gray-200/60">
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="relative">
                  <Filter size={20} className="absolute left-4 top-3.5 text-slate-400" />
                  <select
                    value={statusFilter}
                  ...
                  <div className="p-6 hover:bg-slate-50/50 transition-all duration-300">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="text-lg font-bold text-cyan-600">{order.orderNo}</div>
                          <div className="text-sm text-slate-500">{order.user || "Guest"}</div>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                      ...
                      <div>
                        ...
                        <div className="font-semibold text-slate-800">{order.time}</div>
                      </div>
                      <div>
                        <span className="text-slate-500 font-medium">Items:</span>
                        <div className="font-semibold text-slate-800">{order.items.length}</div>
                      </div>
                      <div>
                    ...
                    <div className="flex items-center space-x-3">
                      <button
                        onClick={() => handleButtonClick(`details-${index}`, () => setExpandedOrder(expandedOrder === index ? null : index))}
                        className={`flex-1 px-4 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-2xl font-semibold transition-all duration-300 flex items-center justify-center space-x-2 transform ${
                          clickedButton === `details-${index}` ? "scale-95 from-blue-600 to-indigo-700 shadow-lg" : "hover:from-blue-600 hover:to-indigo-700 hover:shadow-lg hover:scale-105"
                        }`}>
                        <Eye size={16} />
                        <span>Details</span>
                      </button>
                      <button 
                        onClick={() => handleButtonClick(`edit-${index}`, () => setEditingOrder(order))}
                        className={`p-3 bg-emerald-500 text-white rounded-2xl transition-all duration-300 transform ${
                          clickedButton === `edit-${index}` ? "scale-90 bg-emerald-600 shadow-lg" : "hover:bg-emerald-600 hover:scale-110"
                        }`}>
                        <Edit size={16} />
                      </button>
                      <button 
                        ...
                        className={`p-3 bg-red-500 text-white rounded-2xl transition-all duration-300 transform ${
                          clickedButton === `delete-${index}` ? "scale-90 bg-red-600 shadow-lg" : "hover:bg-red-600 hover:scale-110"
                        }`}>
                        <Trash2 size={16} />
                      </button>
                    </div>
                      ...
                      <div className="mt-6 pt-6 border-t border-slate-200/50 space-y-6">
                        <div>
                          ...
                          <div className="space-y-3">
                            {order.items.map((item, itemIndex) => (
                              <div key={itemIndex} className="flex items-center justify-between p-4 bg-slate-50/80 rounded-2xl border border-slate-200/50">
                                <div className="flex-1 min-w-0">
                                  <div className="font-semibold text-slate-800 truncate">{item.name}</div>
                                  <div className="text-sm text-slate-500">Qty: {item.quantity}</div>
                                </div>
                                <div className="font-bold text-emerald-600 text-lg ml-3">{item.price}</div>
                              </div>
                            ))}
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="p-4 bg-slate-50/80 rounded-2xl border border-slate-200/50">
                            <div className="text-sm text-slate-500 mb-1 font-medium">Address:</div>
                            <div className="text-slate-800 mb-3 font-medium">{order.address}</div>
                            <div className="text-sm text-slate-500 mb-1 font-medium">Phone:</div>
                            <div className="text-slate-800 font-medium">{order.phone}</div>
                          </div>
                        </div>

                        <div className="flex flex-wrap gap-3">
                          <button 
                            onClick={() => handleButtonClick(`complete-${index}`)}
                            className={`px-4 py-2 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl font-semibold transition-all duration-300 flex items-center space-x-2 transform ${
                              clickedButton === `complete-${index}` ? "scale-95 from-emerald-600 to-teal-700 shadow-lg" : "hover:from-emerald-600 hover:to-teal-700 hover:shadow-lg hover:scale-105"
                            }`}>
                            <CheckCircle size={14} />
                            <span>Complete</span>
                          </button>
                          <button 
                            onClick={() => handleButtonClick(`process-${index}`)}
                            className={`px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl font-semibold transition-all duration-300 flex items-center space-x-2 transform ${
                              clickedButton === `process-${index}` ? "scale-95 from-blue-600 to-indigo-700 shadow-lg" : "hover:from-blue-600 hover:to-indigo-700 hover:shadow-lg hover:scale-105"
                            }`}>
                            <Clock size={14} />
                          ...
                          <button 
                            ...
                            className={`px-4 py-2 bg-gradient-to-r from-red-500 to-pink-600 text-white rounded-xl font-semibold transition-all duration-300 flex items-center space-x-2 transform ${
                              clickedButton === `fail-${index}` ? "scale-95 from-red-600 to-pink-700 shadow-lg" : "hover:from-red-600 hover:to-pink-700 hover:shadow-lg hover:scale-105"
                            }`}>
                            <XCircle size={14} />
                            <span>Failed</span>
                          </button>
            ...
            <div className="hidden lg:block overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gradient-to-r from-slate-50 to-gray-100 border-b border-gray-200/60">
                  <tr>
                    <th className="px-6 py-5 text-left text-sm font-bold text-slate-800 tracking-wide">#</th>
                    <th className="px-6 py-5 text-left text-sm font-bold text-slate-800 tracking-wide">Order No</th>
                    <th className="px-6 py-5 text-left text-sm font-bold text-slate-800 tracking-wide">Order Date</th>
                    <th className="px-6 py-5 text-left text-sm font-bold text-slate-800 tracking-wide">User</th>
                    <th className="px-6 py-5 text-left text-sm font-bold text-slate-800 tracking-wide">Status</th>
                    <th className="px-6 py-5 text-left text-sm font-bold text-slate-800 tracking-wide">Order Details</th>
                    <th className="px-6 py-5 text-left text-sm font-bold text-slate-800 tracking-wide">Action</th>
                  </tr>
                </thead>
                  ...
                  {filteredOrders.map((order, index) => (
                    <React.Fragment key={index}>
                      <tr className="hover:bg-slate-50/50 transition-all duration-300 group">
                        <td className="px-6 py-5 text-sm text-slate-800 font-semibold">{index + 1}</td>
                        ...
                        <td className="px-6 py-5">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm text-slate-600 font-medium italic">{order?.user || "Guest"}</span>
                          </div>
                        </td>
                        <td className="px-6 py-5">
                          <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-sm font-semibold ${getStatusColor(order.status)}`}>
                        ...
                        <td className="px-6 py-5">
                          <button
                            onClick={() => handleButtonClick(`details-table-${index}`, () => setExpandedOrder(expandedOrder === index ? null : index))}
                            className={`inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-2xl font-semibold transition-all duration-300 transform ${
                              clickedButton === `details-table-${index}` ? "scale-95 from-blue-600 to-indigo-700 shadow-lg" : "hover:from-blue-600 hover:to-indigo-700 hover:shadow-lg hover:scale-105"
                            }`}>
                            <Eye size={16} className="mr-2" />
                            Details
                            <ChevronDown size={16} className={`ml-2 transition-transform duration-300 ${expandedOrder === index ? "rotate-180" : ""}`} />
                          </button>
                        </td>
                        <td className="px-6 py-5">
                          <div className="flex space-x-3">
                            <button 
                              onClick={() => handleButtonClick(`edit-table-${index}`, () => setEditingOrder(order))}
                              className={`p-3 bg-emerald-500 text-white rounded-2xl transition-all duration-300 transform ${
                                clickedButton === `edit-table-${index}` ? "scale-90 bg-emerald-600 shadow-lg" : "hover:bg-emerald-600 hover:scale-110"
                              }`}>
                              <Edit size={16} />
                            </button>
                            <button 
                              onClick={() => handleButtonClick(`delete-table-${index}`)}
                              className={`p-3 bg-red-500 text-white rounded-2xl transition-all duration-300 transform ${
                                clickedButton === `delete-table-${index}` ? "scale-90 bg-red-600 shadow-lg" : "hover:bg-red-600 hover:scale-110"
                              }`}>
                              <Trash2 size={16} />
                            </button>
                          </div>
                          ...
                          <td colSpan="7" className="px-6 py-8">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                  ...
                                  {order.items.map((item, itemIndex) => (
                                    <div key={itemIndex} className="flex items-center justify-between p-4 bg-slate-50/80 rounded-2xl border border-slate-200/50">
                                      <div className="flex-1">
                                        ...
                                        <div className="text-sm text-slate-500 font-medium">Quantity: {item.quantity}</div>
                                      </div>
                              ...
                              <div className="bg-white/80 rounded-3xl p-6 border border-slate-200/60 shadow-lg">
                                ...
                                <div className="space-y-6">
                                  <div>
                                    <label className="text-sm font-semibold text-slate-600 block mb-2">Customer Address</label>
                                    <div className="p-4 bg-slate-50/80 rounded-2xl border border-slate-200/50">
                                      <span className="text-slate-800 font-medium">{order.address}</span>
                                    </div>
                                  </div>
                                  <div>
                                    <label className="text-sm font-semibold text-slate-600 block mb-2">Phone Number</label>
                                    <div className="p-4 bg-slate-50/80 rounded-2xl border border-slate-200/50">
                                      <span className="text-slate-800 font-medium">{order.phone}</span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="mt-8 flex flex-wrap gap-4">
                              <button 
                                onClick={() => handleButtonClick(`complete-table-${index}`)}
                                className={`px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-2xl font-semibold transition-all duration-300 flex items-center space-x-2 transform ${
                                  clickedButton === `complete-table-${index}` ? "scale-95 from-emerald-600 to-teal-700 shadow-lg" : "hover:from-emerald-600 hover:to-teal-700 hover:shadow-xl hover:scale-105"
                                }`}>
                                <CheckCircle size={18} />
                                <span>Mark as Completed</span>
                              </button>
                              <button 
                                onClick={() => handleButtonClick(`process-table-${index}`)}
                                className={`px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-2xl font-semibold transition-all duration-300 flex items-center space-x-2 transform ${
                                  clickedButton === `process-table-${index}` ? "scale-95 from-blue-600 to-indigo-700 shadow-lg" : "hover:from-blue-600 hover:to-indigo-700 hover:shadow-xl hover:scale-105"
                                }`}>
                                <Clock size={18} />
                                <span>Mark as Processing</span>
                              </button>
                              <button 
                                onClick={() => handleButtonClick(`fail-table-${index}`)}
                                className={`px-6 py-3 bg-gradient-to-r from-red-500 to-pink-600 text-white rounded-2xl font-semibold transition-all duration-300 flex items-center space-x-2 transform ${
                                  clickedButton === `fail-table-${index}` ? "scale-95 from-red-600 to-pink-700 shadow-lg" : "hover:from-red-600 hover:to-pink-700 hover:shadow-xl hover:scale-105"
                                }`}>
                                <XCircle size={18} />
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/60 px-8 py-6">
              <div className="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between">
                <div className="text-sm text-slate-600 text-center sm:text-left font-medium">
                  ...
                  <span className="font-bold text-slate-800">{filteredOrders.length}</span> of{" "}
                  <span className="font-bold text-slate-800">{filteredOrders.length}</span> results
                </div>
                <div className="flex justify-center space-x-3">
                  <button 
                    ...
                    className={`px-6 py-3 bg-white/80 text-slate-400 rounded-2xl border border-slate-200 cursor-not-allowed font-semibold transform ${
                      clickedButton === "prev-page" ? "scale-95 bg-slate-100 shadow-lg" : ""
                    }`}>
                    Previous
                  </button>
                  <button 
                    ...
                    className={`px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-700 text-white rounded-2xl font-bold shadow-lg transform ${
                      clickedButton === "current-page" ? "scale-95 from-cyan-700 to-blue-800 shadow-lg" : "hover:from-cyan-700 hover:to-blue-800 hover:shadow-xl hover:scale-105"
                    }`}>
                    1
                  </button>
                  <button 
                    ...
                    className={`px-6 py-3 bg-white/80 text-slate-400 rounded-2xl border border-slate-200 cursor-not-allowed font-semibold transform ${
                      clickedButton === "next-page" ? "scale-95 bg-slate-100 shadow-lg" : ""
                    }`}>
                    Next
                  </button>
                </div>
